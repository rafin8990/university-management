...
const updateFaculties = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
...
const deleteFaculty = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const session = yield faculty_model_1.Faculty.startSession();
    session.startTransaction();
    try {
        const facultyResult = yield faculty_model_1.Faculty.findByIdAndDelete(id).session(session);
        if (!facultyResult) {
            throw new ApiError_1.default(http_status_1.default.NOT_FOUND, 'Faculty Does not exist');
        }
